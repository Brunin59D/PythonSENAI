...
while True:
    ...
    exibir_mensagem(opcao, opcao_soma, opcao_subtracao, opcao_multiplicacao, opcao_divisao, operacao_subtracao, operacao_soma, operacao_divisao, operacao_multiplicacao)1
